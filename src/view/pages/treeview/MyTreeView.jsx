...
const MyTreeView = () => {
  ...
  const [docList,setData]=useState([])
  const newArray = docList.map((item, index) => {
    const title = item.title;
    const [projectCode, areaCode,departmentCode, _] = title.split('-');
    return {
        id: index + 1,
        title: title,
...
console.log("newwwwwwww",newArray);
  const projects = [
    // information
    { id: 1, title: '2014-01-PM-REP-001', companyId: 1, departmentId: '1', projectId: '1', mdr: "1" },
    { id: 2, title: '2014-01-PRO-REP-001', companyId: 1, departmentId: '2', projectId: '2', mdr: "2" },
