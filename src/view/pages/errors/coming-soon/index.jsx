...
import { ConstructionSharp, DeveloperBoardOff, DeveloperMode } from "@mui/icons-material";
    ...
    <Row className="hp-text-center hp-overflow-hidden">
      ...
      <Col className="hp-error-content hp-py-32" span={24}>
        <Row className="hp-h-100" align="middle" justify="center">
          <Col>
          <h1 className="h1 hp-mb-16">Under Development</h1><ConstructionSharp style={{fontSize:"32px",fontWeight:"bold"}}/>
