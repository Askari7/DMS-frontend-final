...
const PagesRoutes = [
  ...
  {
    path: "/pages/review-documents",
    component: lazy(() => import("../../view/pages/review_documents")),
    layout: "VerticalLayout",
    isProtected: true,
  },
  {
  ...
  // {
  //   path: "/pages/timeline",
  //   component: lazy(() => import("../../view/pages/timeliner")),
  //   layout: "VerticalLayout",
  //   isProtected: true,
  // },
  {
    path: "/pages/document-assessment",
    component: lazy(() => import("../../view/pages/document_assessment")),
    layout: "VerticalLayout",
    isProtected: true,
  },
  {
  ...
  {
    path: "/pages/profile/change-profile",
    component: lazy(() => import("../../view/pages/profile")),
    layout: "VerticalLayout",
    isProtected: true,
  },
